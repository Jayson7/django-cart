...
#     # more_posters = forms.FileField(required=False, widget=forms.FileInput(attrs={
#     #     "class": "form-control",
#     #     "multiple": True
#     # }))
...
#     class Meta:
#         model = Products
#         fields = ["title", "slug", "category", "poster", "main_price",
#                   "discounted_price", "description", "warranty", "return_policy"]
#         widgets = {
...
#                 "class": "form-control"
#             }),
#             "main_price": forms.NumberInput(attrs={
#                 "class": "form-control",
